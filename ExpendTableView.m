...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        // Initialization code
        expendTab = [[UITableView alloc]initWithFrame:CGRectMake(10, 10, SCREEN_WIDTH-20, self.nameAry.count*38+30) style:UITableViewStyleGrouped];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [name release];
    //数据栏
    UILabel * data = [[UILabel alloc]initWithFrame:CGRectMake(140, 10, SCREEN_WIDTH-200, 18)];
